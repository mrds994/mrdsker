...
function status($Red)
	{
$fg = file_get_contents('http://controlc.com/ab6d6377');
$ex = explode('content="status:',$fg)[1];
$stat = explode(' -',$ex)[0];
if($stat=="online"){
	} else if($stat=="offline"){
		echo "$Red ╰┈➤ Server down, contact me at agathasangkara@proton.me\n\n"; die;
	} else {
	echo "$Red ╰┈➤ 403 Forbidden, contact me at agathasangkara@proton.me\n\n"; die;
	}
}
